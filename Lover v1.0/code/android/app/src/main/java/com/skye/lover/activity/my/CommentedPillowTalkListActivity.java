 ...
 * 用户评论过的悄悄话列表
 */
public class CommentedPillowTalkListActivity extends BaseActivity implements AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onRefresh() {
        ...
        OkHttpUtil.doPost(context, URLConfig.ACTION_COMMENTED_PILLOW_TALKS, params, callbackRefresh);
    }
    ...
    public void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
        ...
        if (!refreshing && !requestingMore && !isLastPage) {
            ...
            if (lastInScreen >= totalItemCount) {
                ...
                params.put("page", page + "");
                dialog = CommonUtil.showLoadingDialog(context, R.string.loading);
                OkHttpUtil.doPost(context, URLConfig.ACTION_COMMENTED_PILLOW_TALKS, params, callbackLoadMore);
            }
        }
    }
