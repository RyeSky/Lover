 ...
 * 用户赞过的悄悄话列表
 */
public class PraisedPillowTalkListActivity extends BaseActivity implements AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onRefresh() {
        ...
        OkHttpUtil.doPost(context, URLConfig.ACTION_PRAISED_PILLOW_TALKS, params, callbackRefresh);
    }
    ...
    public void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
        ...
        if (!refreshing && !requestingMore && !isLastPage) {
            ...
            if (lastInScreen >= totalItemCount) {
                ...
                params.put("page", page + "");
                dialog = CommonUtil.showLoadingDialog(context, R.string.loading);
                OkHttpUtil.doPost(context, URLConfig.ACTION_PRAISED_PILLOW_TALKS, params, callbackLoadMore);
            }
        }
    }
            ...
            public void onItemClick(int itemPosition) {
                switch (itemPosition) {
                    case 0:
                        ...
                        OkHttpUtil.doPost(context, URLConfig.ACTION_CANCEL_PRAISE, params, new CallbackCancelPraise(position));
                        break;
                    default:
                        break;
                }
     ...
     * 取消赞悄悄话接口回调
     */
    private class CallbackCancelPraise implements Callback {
        private int position;

        CallbackCancelPraise(int position) {
