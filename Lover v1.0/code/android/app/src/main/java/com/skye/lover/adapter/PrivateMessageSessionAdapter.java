    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!TextUtils.isEmpty(pms.getAnotherAvatar())) {
            ...
            if (!tag.equals(vh.avatar.getTag())) {
                ImageLoader.getInstance().displayImage(pms.getAnotherAvatar(), vh.avatar, CommonUtil.getDisplayOptions(pms.getAnotherGender()));
                vh.avatar.setTag(tag);
            }
        } else {
            vh.avatar.setImageResource(CommonUtil.getDefaultImageResource(pms.getAnotherGender()));
