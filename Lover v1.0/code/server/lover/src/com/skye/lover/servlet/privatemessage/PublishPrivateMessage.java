 ...
 * </p>
 */
public class PublishPrivateMessage extends HttpServlet {

    private class Parameter {
        @Expose
        String userId, another, content;// 用户id，聊天中的另一方，聊天内容
        ...
        public String toString() {
            return "Parameter{" + "userId='" + userId + '\'' + ", another='" + another + '\'' + ", content='" + content + '\'' + '}';
        }
    }
