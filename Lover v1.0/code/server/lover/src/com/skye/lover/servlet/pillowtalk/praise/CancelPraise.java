package com.skye.lover.servlet.pillowtalk.praise;

import com.google.gson.annotations.Expose;
import com.skye.lover.model.BaseResponse;
import com.skye.lover.service.PraiseService;
 ...
 * </p>
 */
public class CancelPraise extends HttpServlet {

    private class Parameter {
        @Expose
        String pillowTalkId, userId;// 悄悄话id，赞者
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!CommonUtil.isBlank(parameter)) {// 请求参数不为空
            ...
            if (param != null && param.check()) {// 请求参数不为空
                PraiseService ps = new PraiseService();
