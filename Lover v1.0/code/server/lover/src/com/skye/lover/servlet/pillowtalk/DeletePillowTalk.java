 ...
 * </p>
 */
public class DeletePillowTalk extends HttpServlet {

    private class Parameter {
        @Expose
        String userId, pillowTalkId;// 用户id，悄悄话id
        ...
        public String toString() {
            return "Parameter [userId=" + userId + ",pillowTalkId=" + pillowTalkId + "]";
        }
