 ...
 * </p>
 */
public class DeleteFollowPillowTalk extends HttpServlet {

    private class Parameter {
        @Expose
        String userId, followPillowTalkId;// 用户id，悄悄话id
        ...
        public boolean check() {
            return !CommonUtil.isBlank(userId)
                    && !CommonUtil.isBlank(followPillowTalkId);
        }

        @Override
        public String toString() {
            return "Parameter [userId=" + userId + ", followPillowTalkId="
                    + followPillowTalkId + "]";
        }
