 ...
 * </table>
 */
public class HoneyWord extends HttpServlet {
    ...
    private class Parameter {
        ...
        public boolean check() {
            return !CommonUtil.isBlank(userId) && !CommonUtil.isBlank(another) && page > 0;
        }

        @Override
        public String toString() {
            return "Parameter [userId=" + userId + ",another=" + another + ", page=" + page + "]";
        }
