...
public class JPushUtil {
    ...
    private static void push(PushPayload... payloads) {
        ...
        JPushClient client = new JPushClient(ConstantUtil.JPUSH_SECRET, ConstantUtil.JPUSH_APP_KEY);
    ...
    private static class Builder {
        ...
        private static PushPayload buildAndroidPushPayload(String title, Map<String, String> extraParams) {
            return PushPayload.newBuilder()
                    ...
                    .setNotification(Notification.android(title, ConstantUtil.PROJECT_NAME, extraParams))
                    .build();
        }
