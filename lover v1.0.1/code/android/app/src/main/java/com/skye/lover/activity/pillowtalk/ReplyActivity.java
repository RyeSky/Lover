...
import com.skye.lover.mvp.presenter.ReplyPresenter;
 ...
 * 回复悄悄话界面
 */
public class ReplyActivity extends BaseActivity<BaseView, ReplyPresenter> implements BaseView
        , View.OnTouchListener, FaceContainer.OnFaceOprateListener {
    ...
    public int getDescription() {
        return R.string.reply_activity;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        RxView.clicks(findViewById(R.id.btn_ok)).throttleFirst(1, TimeUnit.SECONDS)
                .subscribe((v) -> {
                    ...
                    presenter.reply(pillowTalkId, content);
                });
        //调用表情键盘
