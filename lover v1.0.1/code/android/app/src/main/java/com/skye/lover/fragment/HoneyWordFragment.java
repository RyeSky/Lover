...
import com.skye.lover.mvp.model.impl.HoneyWordModelImpl;
 ...
 * 蜜语碎片
 */
public class HoneyWordFragment extends BaseFragment<PillowTalkListView, PillowTalkListPresenter> implements PillowTalkListView, AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public PillowTalkListPresenter createPresenter() {
        return new PillowTalkListPresenter(new HoneyWordModelImpl());
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        RxView.clicks(topbar.right).throttleFirst(1, TimeUnit.SECONDS)
                .subscribe((v) -> activity.startActivityForResult(new Intent(activity, PublishPillowTalkActivity.class)
