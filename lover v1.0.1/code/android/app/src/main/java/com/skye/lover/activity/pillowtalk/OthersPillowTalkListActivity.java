...
import com.skye.lover.mvp.model.impl.OthersPillowTalkListImpl;
 ...
 * 其他用户发表的悄悄话列表界面
 */
public class OthersPillowTalkListActivity extends BaseActivity<PillowTalkListView, PillowTalkListPresenter> implements PillowTalkListView, AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public PillowTalkListPresenter createPresenter() {
        return new PillowTalkListPresenter(new OthersPillowTalkListImpl(userId));
    }

    @Override
    public int getDescription() {
        return R.string.others_pillow_talk_list_activity;
    }
