 ...
 * 用户评论过的悄悄话列表模型实现
 */
public class CommentedPillowTalkListImpl implements PillowTalkListModel {
    private int page = 1;
    ...
    public Cross refresh(Context context) {
        ...
        return OkHttpUtil.buildPostCall(URLConfig.ACTION_COMMENTED_PILLOW_TALKS, params, true, true);
    }
